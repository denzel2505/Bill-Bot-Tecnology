    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a class="active" href="./home.php"><span class="icon home" aria-hidden="true"></span>Dashboard</a>
                </li>
                <li>
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <div class="info-principal">
          ...
          <a href="./busqueda.php">+ Crear</a>
        </div>
        <h2 class="main-title" style="text-align: center;">Aun no hay documentos</h2>
        <p class="main-title" style="font-size: 15px; text-align: center; margin:20px 0 0 0;">Presione crear para buscar</p>
