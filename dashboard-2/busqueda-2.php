...
<div class="page-flex">
    ...
    <div class="sidebar-start">
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a href="../dashboard-2/home-2.php"><span class="icon home" aria-hidden="true"></span>Dashboard</a>
                </li>
                <li>
  ...
  <div class="container main-nav">
    ...
    <form action="../dashboard-2/busqueda-2.php" method="POST">
    ...
    <?php if ($factura): ?>
        ...
        <form action="../dashboard-2/arm-cuentas.php" method="POST">
